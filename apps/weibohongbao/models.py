...
class WeiboUser(models.Model):
    ...
    session_status = models.CharField(max_length=1,verbose_name="会话状态,0-存活,1-失效")
...
class WeiboSendList(models.Model):
    ...
    umark = models.CharField(max_length=1,verbose_name="发红包状态,0-已发,1-未发",default="1")
    status = models.CharField(max_length=1,verbose_name="状态,0-已抢完,1-正在抢",default='1')
    taskid = models.IntegerField(verbose_name="任务ID")

    swithurl = models.CharField(max_length=512,verbose_name="红包跳转链接,发红包用",default="")
...
class WeiboTask(models.Model):
    ...
    robnumber = models.IntegerField(verbose_name="抢红包人数,必须被100的整数",default=0)
    ...
    sort = models.IntegerField(verbose_name="执行顺序")

    progree = models.IntegerField(verbose_name="进度")

    umark = models.CharField(max_length=1,verbose_name="开启:0-开启,1-未开启")
    status = models.CharField(max_length=1,verbose_name="状态:0-已完成,1-待完成,2-放弃")
